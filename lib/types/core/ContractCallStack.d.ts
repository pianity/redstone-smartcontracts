...
export declare class InteractionInput {
    ...
    constructor(txId: string, blockHeight: number, blockTimestamp: number, caller: string, functionName: string, functionArguments: [], dryWrite: boolean, foreignContractCalls?: Map<string, ContractCallStack>);
}
export declare class InteractionOutput {
    readonly cacheHit: boolean;
    readonly intermediaryCacheHit: boolean;
    readonly outputState: any;
    readonly executionTime: number;
    readonly valid: boolean;
    readonly errorMessage: string;
    readonly gasUsed: number;
    constructor(cacheHit: boolean, intermediaryCacheHit: boolean, outputState: any, executionTime: number, valid: boolean, errorMessage: string, gasUsed: number);
}
