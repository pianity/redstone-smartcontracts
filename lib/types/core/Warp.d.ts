...
export declare class Warp {
    ...
    constructor(arweave: Arweave, levelDb: LevelDbCache<EvalStateResult<unknown, unknown>>, definitionLoader: DefinitionLoader, interactionsLoader: InteractionsLoader, executorFactory: ExecutorFactory<HandlerApi<unknown>>, stateEvaluator: StateEvaluator, environment?: WarpEnvironment);
    static builder(arweave: Arweave, cache: LevelDbCache<EvalStateResult<unknown, unknown>>, environment: WarpEnvironment): WarpBuilder;
    /**
