import { ContractDefinition, CurrentTx, EvalStateResult, ExecutionContext, GQLNodeInterface, HandlerApi, InteractionData, InteractionResult, SmartWeaveGlobal } from '../../../../index';
export declare abstract class AbstractContractHandler<State> implements HandlerApi<State> {
    ...
    protected logger: import("../../../../index").WarpLogger;
