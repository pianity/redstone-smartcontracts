...
export declare class InteractionCompleteEvent<Input = unknown, T = unknown> {
    ...
    readonly data: T;
    constructor(contractTxId: string, sortKey: string, transactionId: string, caller: string, input: Input, blockTimestamp: number, blockHeight: number, data: T);
}
