...
export declare type WriteInteractionResponseFailure<Err> = {
    type: 'error' | 'exception';
    error: Err;
};
export declare type WriteInteractionResponse<Err> = WriteInteractionResponseSuccess | WriteInteractionResponseFailure<Err>;
export declare type CreateInteractionResponse<Err> = {
    type: 'ok';
