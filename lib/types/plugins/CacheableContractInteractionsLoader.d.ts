import { BlockHeightWarpCache, EvaluationOptions, GQLEdgeInterface, InteractionsLoader } from '../index';
/**
...
export declare class CacheableContractInteractionsLoader implements InteractionsLoader {
    ...
    constructor(baseImplementation: InteractionsLoader, cache: BlockHeightWarpCache<GQLEdgeInterface[]>);
