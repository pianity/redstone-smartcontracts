import { ArweaveWrapper, Benchmark, BundleInteractionError, ContractCallStack, createDummyTx, createTx, DefaultEvaluationOptions, emptyTransfer, Evolve, InnerWritesEvaluator, InteractionsLoaderError, LoggerFactory, sleep, SmartWeaveTags, SourceType } from '..';
...
export class HandlerBasedContract {
    ...
    async createInteraction(input, tags, transfer, strict, bundle = false, vrf = false) {
        ...
        const interactionTx = await createTx(this.smartweave.arweave, this.signer, this._contractTxId, input, tags, transfer.target, transfer.winstonQty, bundle);
