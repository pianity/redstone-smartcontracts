import { WarpBuilder } from './index';
import { HandlerBasedContract, DefaultCreateContract, PstContractImpl } from '../contract/index';
/**
 ...
 */
export class Warp {
    constructor(arweave, definitionLoader, interactionsLoader, interactionsSorter, executorFactory, stateEvaluator, useWarpGwInfo = false) {
        ...
        this.useWarpGwInfo = useWarpGwInfo;
