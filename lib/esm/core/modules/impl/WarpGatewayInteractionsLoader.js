import { Benchmark, LoggerFactory, stripTrailingSlash, InteractionsLoaderError } from '../../../index';
 ...
 */
export class WarpGatewayInteractionsLoader {
    constructor(baseUrl, confirmationStatus = null, source = null) {
        this.baseUrl = baseUrl;
        this.confirmationStatus = confirmationStatus;
        this.source = source;
        this.logger = LoggerFactory.INST.create('WarpGatewayInteractionsLoader');
