import { ArweaveWrapper, Benchmark, LoggerFactory, sleep, SmartWeaveTags } from '../../../index';
const MAX_REQUEST = 100;
export function bundledTxsFilter(tx) {
    var _a, _b;
    return !((_a = tx.node.parent) === null || _a === void 0 ? void 0 : _a.id) && !((_b = tx.node.bundledIn) === null || _b === void 0 ? void 0 : _b.id);
}
export class ArweaveGatewayInteractionsLoader {
    constructor(arweave) {
