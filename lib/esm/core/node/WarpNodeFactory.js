import { CacheableStateEvaluator, HandlerExecutorFactory, LexicographicalInteractionsSorter, R_GW_URL, WarpGatewayContractDefinitionLoader, WarpGatewayInteractionsLoader, Warp, WarpWebFactory } from '../index';
import { CacheableExecutorFactory, Evolve } from '../../plugins/index';
import { FileBlockHeightWarpCache, MemCache } from '../../cache/index';
...
export class WarpNodeFactory extends WarpWebFactory {
    ...
    static fileCachedBased(arweave, cacheBasePath, maxStoredInMemoryBlockHeights = 10, confirmationStatus = { notCorrupted: true }) {
        ...
        const stateEvaluator = new CacheableStateEvaluator(arweave, new FileBlockHeightWarpCache(cacheBasePath, maxStoredInMemoryBlockHeights), [new Evolve(definitionLoader, executorFactory)]);
