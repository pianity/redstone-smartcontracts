...
import { MemBlockHeightWarpCache } from '../index';
 ...
 */
export class FileBlockHeightWarpCache extends MemBlockHeightWarpCache {
    constructor(basePath = path.join(__dirname, 'storage', 'state'), maxStoredInMemoryBlockHeights = Number.MAX_SAFE_INTEGER) {
        ...
        this.fLogger = LoggerFactory.INST.create('FileBlockHeightWarpCache');
