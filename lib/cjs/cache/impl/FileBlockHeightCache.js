...
exports.FileBlockHeightWarpCache = void 0;
 ...
 */
class FileBlockHeightWarpCache extends cache_1.MemBlockHeightWarpCache {
    constructor(basePath = path_1.default.join(__dirname, 'storage', 'state'), maxStoredInMemoryBlockHeights = Number.MAX_SAFE_INTEGER) {
        ...
        this.fLogger = logging_1.LoggerFactory.INST.create('FileBlockHeightWarpCache');
...
exports.FileBlockHeightWarpCache = FileBlockHeightWarpCache;
