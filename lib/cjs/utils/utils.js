...
class NetworkCommunicationError extends Error {
    constructor(error) {
        ...
        this.error = error;
        this.name = JsHandlerApi_1.KnownErrors.NetworkCommunicationError;
    }
}
exports.NetworkCommunicationError = NetworkCommunicationError;
...
async function safeGet(input, init) {
