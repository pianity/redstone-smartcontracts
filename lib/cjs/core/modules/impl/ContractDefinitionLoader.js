...
class ContractDefinitionLoader {
    ...
    cache) {
        ...
        this.cache = cache;
        this.logger = _warp_1.LoggerFactory.INST.create('ContractDefinitionLoader');
    ...
    async doLoad(contractTxId, forcedSrcTxId) {
        ...
        benchmark.reset();
        const contractSrcTxId = forcedSrcTxId ? forcedSrcTxId : (0, _warp_1.getTag)(contractTx, _warp_1.SmartWeaveTags.CONTRACT_SRC_TX_ID);
        const minFee = (0, _warp_1.getTag)(contractTx, _warp_1.SmartWeaveTags.MIN_FEE);
    ...
    async loadContractSource(contractSrcTxId) {
        ...
        const srcContentType = (0, _warp_1.getTag)(contractSrcTx, _warp_1.SmartWeaveTags.CONTENT_TYPE);
        ...
        if (contractType == 'wasm') {
            ...
            srcWasmLang = (0, _warp_1.getTag)(contractSrcTx, _warp_1.SmartWeaveTags.WASM_LANG);
            if (!srcWasmLang) {
                throw new Error(`Wasm lang not set for wasm contract src ${contractSrcTxId}`);
            }
            srcMetaData = JSON.parse((0, _warp_1.getTag)(contractSrcTx, _warp_1.SmartWeaveTags.WASM_META));
        }
    ...
    async evalInitialState(contractTx) {
        if ((0, _warp_1.getTag)(contractTx, _warp_1.SmartWeaveTags.INIT_STATE)) {
            return (0, _warp_1.getTag)(contractTx, _warp_1.SmartWeaveTags.INIT_STATE);
        }
        else if ((0, _warp_1.getTag)(contractTx, _warp_1.SmartWeaveTags.INIT_STATE_TX)) {
            const stateTX = (0, _warp_1.getTag)(contractTx, _warp_1.SmartWeaveTags.INIT_STATE_TX);
