    ...
    async load(contractId, fromBlockHeight, toBlockHeight, evaluationOptions, upToTransactionId) {
        ...
        do {
            ...
            const response = await fetch(`${url}?${new URLSearchParams({
                ...
                switch (error.status) {
                    case 504:
                        throw new _smartweave_1.InteractionsLoaderError('BadGatewayResponse504', errorMessage, error);
                    case 500:
                        throw new _smartweave_1.InteractionsLoaderError('BadGatewayResponse500', errorMessage, error);
                    default:
                        throw new _smartweave_1.InteractionsLoaderError('BadGatewayResponse', errorMessage, error);
                }
            });
