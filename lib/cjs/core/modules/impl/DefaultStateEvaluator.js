    ...
    async doReadState(missingInteractions, baseState, executionContext, currentTx) {
        ...
        for (let i = 0; i < missingInteractionsLength; i++) {
            ...
            if (isInteractWrite && internalWrites) {
                ...
                await this.onContractCall(missingInteraction, executionContext, new StateEvaluator_1.EvalStateResult(currentState, validity, errors));
                ...
                if (newState !== null) {
                    ...
                    if ((_a = newState.cachedValue.errors) === null || _a === void 0 ? void 0 : _a[missingInteraction.id]) {
                        errors[missingInteraction.id] = newState.cachedValue.errors[missingInteraction.id];
                    }
                    const toCache = new StateEvaluator_1.EvalStateResult(currentState, validity, errors);
                ...
                const result = await executionContext.handler.handle(executionContext, new StateEvaluator_1.EvalStateResult(currentState, validity, errors), interactionData);
        ...
        const evalStateResult = new StateEvaluator_1.EvalStateResult(currentState, validity, errors);
