...
exports.configureContext = exports.configureSandbox = void 0;
const isolated_vm_1 = __importDefault(require("isolated-vm"));
const _warp_1 = require("../../../../index");
const bigNumber_ivm_1 = require("./bigNumber-ivm");
...
function configureSandbox(sandbox, arweave, swGlobal) {
    // ContractAssert
    sandbox.setSync('ContractAssert', function (cond, message) {
        if (!cond)
            throw new ContractError(message);
    });
    const logger = _warp_1.LoggerFactory.INST.create(`${swGlobal.contract.id}`);
    // logger
    ...
    // SmartWeave - contract
    sandbox.setSync('__host__smartweave__contract', new isolated_vm_1.default.ExternalCopy(swGlobal.contract));
    ...
    sandbox.setSync('__host__smartweave__contracts_readContractState', new isolated_vm_1.default.Reference(async function (...args) {
        // eslint-disable-next-line prefer-spread
        const result = await swGlobal.contracts.readContractState.apply(swGlobal, args);
        return new isolated_vm_1.default.ExternalCopy(result);
    }));
    sandbox.setSync('__host__smartweave__contracts_write', new isolated_vm_1.default.Reference(async function (...args) {
        const result = await swGlobal.contracts.write.apply(swGlobal, args);
        return new isolated_vm_1.default.ExternalCopy(result);
    }));
    sandbox.setSync('__host__smartweave__contracts_viewContractState', new isolated_vm_1.default.Reference(async function (...args) {
        const result = await swGlobal.contracts.viewContractState.apply(swGlobal, args);
        return new isolated_vm_1.default.ExternalCopy(result);
    }));
    sandbox.setSync('__host__smartweave__contracts_refreshState', new isolated_vm_1.default.Reference(async function (...args) {
        const result = await swGlobal.contracts.refreshState.apply(swGlobal, args);
        return new isolated_vm_1.default.ExternalCopy(result);
    }));
    // SmartWeave - getBalance
    sandbox.setSync('__host__smartweave_getBalance', new isolated_vm_1.default.Reference(async function (...args) {
        // eslint-disable-next-line prefer-spread
        return await swGlobal.getBalance.apply(swGlobal, args);
    }));
    // SmartWeave - vrf
    sandbox.setSync('__host__smartweave__vrf_data', function (...args) {
        return new isolated_vm_1.default.ExternalCopy(swGlobal.vrf.data);
    });
    ...
    sandbox.setSync('__host__smartweave__arweave__ar_winstonToAr', new isolated_vm_1.default.Reference(arweave.ar.winstonToAr));
    sandbox.setSync('__host__smartweave__arweave__ar_arToWinston', new isolated_vm_1.default.Reference(arweave.ar.arToWinston));
    sandbox.setSync('__host__smartweave__arweave__ar_compare', new isolated_vm_1.default.Reference(arweave.ar.compare));
    sandbox.setSync('__host__smartweave__arweave__ar_isEqual', new isolated_vm_1.default.Reference(arweave.ar.isEqual));
    sandbox.setSync('__host__smartweave__arweave__ar_isLessThan', new isolated_vm_1.default.Reference(arweave.ar.isLessThan));
    sandbox.setSync('__host__smartweave__arweave__ar_isGreaterThan', new isolated_vm_1.default.Reference(arweave.ar.isGreaterThan));
    sandbox.setSync('__host__smartweave__arweave__ar_add', new isolated_vm_1.default.Reference(arweave.ar.add));
    sandbox.setSync('__host__smartweave__arweave__ar_sub', new isolated_vm_1.default.Reference(arweave.ar.sub));
    // SmartWeave - arweave - utils
    sandbox.setSync('__host__smartweave__arweave__utils_concatBuffers', new isolated_vm_1.default.Reference(arweave.utils.concatBuffers));
    sandbox.setSync('__host__smartweave__arweave__utils_b64UrlToString', new isolated_vm_1.default.Reference(arweave.utils.b64UrlToString));
    sandbox.setSync('__host__smartweave__arweave__utils_bufferToString', new isolated_vm_1.default.Reference(arweave.utils.bufferToString));
    sandbox.setSync('__host__smartweave__arweave__utils_stringToBuffer', new isolated_vm_1.default.Reference(arweave.utils.stringToBuffer));
    sandbox.setSync('__host__smartweave__arweave__utils_stringToB64Url', new isolated_vm_1.default.Reference(arweave.utils.stringToB64Url));
    sandbox.setSync('__host__smartweave__arweave__utils_b64UrlToBuffer', new isolated_vm_1.default.Reference(arweave.utils.b64UrlToBuffer));
    sandbox.setSync('__host__smartweave__arweave__utils_bufferTob64', new isolated_vm_1.default.Reference(arweave.utils.bufferTob64));
    sandbox.setSync('__host__smartweave__arweave__utils_bufferTob64Url', new isolated_vm_1.default.Reference(arweave.utils.bufferTob64Url));
    sandbox.setSync('__host__smartweave__arweave__utils_b64UrlEncode', new isolated_vm_1.default.Reference(arweave.utils.b64UrlEncode));
    sandbox.setSync('__host__smartweave__arweave__utils_b64UrlDecode', new isolated_vm_1.default.Reference(arweave.utils.b64UrlDecode));
    ...
    sandbox.setSync('__host__smartweave__arweave__wallets_getBalance', new isolated_vm_1.default.Reference(async function () {
        throw new Error('this function is non-deterministic');
    }));
    sandbox.setSync('__host__smartweave__arweave__wallets_getLastTransactionID', new isolated_vm_1.default.Reference(async function () {
        throw new Error('this function is non-deterministic');
    }));
    sandbox.setSync('__host__smartweave__arweave__wallets_generate', new isolated_vm_1.default.Reference(async function () {
        throw new Error('this function is non-deterministic');
    }));
    sandbox.setSync('__host__smartweave__arweave__wallets_jwkToAddress', new isolated_vm_1.default.Reference(arweave.wallets.jwkToAddress));
    sandbox.setSync('__host__smartweave__arweave__wallets_getAddress', new isolated_vm_1.default.Reference(arweave.wallets.getAddress));
    sandbox.setSync('__host__smartweave__arweave__wallets_ownerToAddress', new isolated_vm_1.default.Reference(arweave.wallets.ownerToAddress));
    ...
    sandbox.setSync('__host__smartweave__arweave__crypto_generateJWK', new isolated_vm_1.default.Reference(async function () {
        throw new Error('this function is non-deterministic');
    }));
    sandbox.setSync('__host__smartweave__arweave__crypto_sign', new isolated_vm_1.default.Reference(async function () {
        throw new Error('this function is non-deterministic');
    }));
    sandbox.setSync('__host__smartweave__arweave__crypto_verify', new isolated_vm_1.default.Reference(arweave.crypto.verify));
    sandbox.setSync('__host__smartweave__arweave__crypto_encrypt', new isolated_vm_1.default.Reference(arweave.crypto.encrypt));
    sandbox.setSync('__host__smartweave__arweave__crypto_decrypt', new isolated_vm_1.default.Reference(arweave.crypto.decrypt));
    sandbox.setSync('__host__smartweave__arweave__crypto_hash', new isolated_vm_1.default.Reference(async function (...args) {
        // eslint-disable-next-line prefer-spread
        const result = await arweave.crypto.hash.apply(arweave.crypto, args);
        return new isolated_vm_1.default.ExternalCopy(result);
    }));
    // arweave - unsafeClient - transactions
    sandbox.setSync('__host__smartweave__arweave__transactions_get', new isolated_vm_1.default.Reference(async function (...args) {
        // eslint-disable-next-line prefer-spread
        const result = await arweave.transactions.get.apply(arweave.transactions, args);
        return new isolated_vm_1.default.ExternalCopy(result);
    }));
    sandbox.setSync('__host__smartweave__arweave__transactions_getData', new isolated_vm_1.default.Reference(async function (...args) {
        // eslint-disable-next-line prefer-spread
...
function configureContext(context) {
    context.evalSync(bigNumber_ivm_1.bigNumberLib);
    context.evalSync(`
...
exports.configureContext = configureContext;
//# sourceMappingURL=configure-ivm.js.map