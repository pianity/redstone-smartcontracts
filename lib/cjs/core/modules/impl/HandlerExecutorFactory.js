...
exports.HandlerExecutorFactory = exports.NonWhitelistedSourceError = exports.ContractError = void 0;
...
class ContractError extends Error {
    constructor(error, subtype) {
        ...
        this.name = JsHandlerApi_1.KnownErrors.ContractError;
    }
}
exports.ContractError = ContractError;
class NonWhitelistedSourceError extends Error {
    constructor(error) {
        super(error.toString());
        this.error = error;
        this.name = JsHandlerApi_1.KnownErrors.NonWhitelistedSourceError;
    }
}
exports.NonWhitelistedSourceError = NonWhitelistedSourceError;
/**
...
class HandlerExecutorFactory {
    ...
    async create(contractDefinition, evaluationOptions, warp, interactionState) {
        if (warp.hasPlugin('contract-blacklist')) {
            await this.blacklistContracts(warp, contractDefinition);
        }
    ...
    checkWhiteListContractSources(contractDefinition, evaluationOptions) {
        if (evaluationOptions &&
            ...
            throw new NonWhitelistedSourceError(`[NonWhitelistedSourceError] Contract source not part of whitelisted sources list: ${contractDefinition.srcTxId}.`);
        }
    }
    async blacklistContracts(warp, contractDefinition) {
