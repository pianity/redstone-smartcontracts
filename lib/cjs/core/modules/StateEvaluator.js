...
exports.InteractionCompleteEvent = exports.CustomEvent = exports.DefaultEvaluationOptions = exports.EvalStateResult = void 0;
...
class DefaultEvaluationOptions {
    constructor() {
        ...
        this.whitelistSources = [];
        this.transactionsPagesPerBatch = null;
    }
}
...
class InteractionCompleteEvent {
    constructor(contractTxId, sortKey, transactionId, caller, input, blockTimestamp, blockHeight, data // eslint-disable-next-line @typescript-eslint/no-empty-function
    ) {
...
exports.InteractionCompleteEvent = InteractionCompleteEvent;
