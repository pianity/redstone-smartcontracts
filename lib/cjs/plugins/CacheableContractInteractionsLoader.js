...
class CacheableContractInteractionsLoader {
    constructor(baseImplementation, cache) {
        ...
        this.cache = cache;
        this.logger = _warp_1.LoggerFactory.INST.create('CacheableContractInteractionsLoader');
    }
    async load(contractId, fromBlockHeight, toBlockHeight, evaluationOptions) {
        ...
        await this.cache.put(new _warp_1.BlockHeightKey(contractId, toBlockHeight), valueToCache);
